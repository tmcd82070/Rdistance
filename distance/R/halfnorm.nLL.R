halfnorm.nLL <- function(a, dist, w.lo=0, w.hi=max(dist), series, expansions=0){
#
#   Compute the negative log likelihood assuming half normal density.
#
#   Input:
#   a = parameter values. Length and meaning depend on series and expansions.
#       a must be at least length = 1.  First element of a is sigma = 
#       variance of normal, 2nd and higher elements are for expansion terms.
...
#	
    ...
    LL = halfnorm.like( a, dist, w.lo=w.lo, w.hi=w.hi, series=series, expansions=expansions )
