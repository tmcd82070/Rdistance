...
Missing values in a particular observation

```{r table2, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Distance        | Group Size  | Transect len  | Contributes to:  |
|:---------------:|:-----------:|:-------------:|:----------------:|
|  present        |   present   |   present     | dfunc; abundance |
|  MISSING        |   present   |   present     | abundance        |
|  present        |   MISSING   |   present     | dfunc            |
|  present        |   present   |   MISSING     | dfunc            |
|  MISSING        |   MISSING   |   present     | dfunc            |
|  present        |   MISSING   |   MISSING     | dfunc            |
|  MISSING        |   present   |   MISSING     | *ignored*        |
|  MISSING        |   MISSING   |   MISSING     | *doesn't happen* |
"
