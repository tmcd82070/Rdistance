...
1.    _Where were you?_: On 13Feb24, you needed to (1) implement matrix calculations for non-halfnorm likelihoods; (2) implement predict.dfunc.density and predict.dfunc.abundance. 
...
10.  *Less than full circle sampled*: Implement parameter that allows 
adjustment when less than a full circle is sampled (for points).  Suggest
replacing 'singleSided' in abundEstim and predict.dfunc with a numeric value, something like propAreaSurveyed = 1 or .5 (for lines) and some number X for lines. 
