...
10. Check the scaling of likelihoods with and without expansion terms. E.g., `autoDistSample` seems to be using vastly different scaling when expansion factors are present. Run it and look at AIC.
