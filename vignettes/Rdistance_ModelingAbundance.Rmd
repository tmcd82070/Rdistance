...
auto <- F.automated.CDA(detection.data=sparrow.detections,
                        ...
                        by.id=TRUE, w.hi=150, area=10000, R=100, ci=0.95,
...
Because distances are measured in meters and `area=10000`, abundance (density) estimates are given as the number of sparrows per hectare.
...
We now have both variables in the same data.frame.  For the sake of demonstration, we will fit a simple linear regression model using the `lm` function to assess the relationship between sagebrush cover and sparrow abundance.  We see that sparrow density increases with sagebrush cover, and density nearly quadruples across the range of sagebrush cover surveyed.
