...
If you can detect your object of interest with perfection, you are doing a "census" and don't need to use distance-sampling.  However, walking though a perfect-detection scenario will set the stage for understanding how distance sampling accounts for imperfect detection.

If detection is perfect, the true abundance is the same as the observed count.
$$N = Count$$

In order to calculate the true density, you also need to know the size of the area surveyed:
