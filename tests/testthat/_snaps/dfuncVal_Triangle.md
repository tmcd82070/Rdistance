# triangle w/ no covariates, same value
    ...
    Output
      ...
      dfuncEstim(data = sparrowDf, formula = dist ~ 1 + groupsize(groupsize), 
          likelihood = "triangle", w.lo = w.lo, w.hi = w.hi, expansions = 0, 
...
# triangle w/ cont covar, same value
...
# triangle w/ factor covar, same value
