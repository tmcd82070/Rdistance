...
2. `form.start.limits` - This function provides the starting values, limits, and names of parameters in the likelihood and should take the following inputs (described above):  `dist`, `w.lo`, and `w.hi`.
