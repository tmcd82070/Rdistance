...
an analysis, the best place to start is one of our vignettes:

* [Beginner Line Transects with Covariates]{Rdistance-beginnerLineTransectCovar.Rmd}
* [Beginner Point Transects with Covariates]{Rdistance-beginnerPointTransectCovar.Rmd}
...
* Overall (study area) and site-level (transect or point) abundance estimates
