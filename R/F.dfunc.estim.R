...
#' @usage F.dfunc.estim(formula, data, likelihood="halfnorm", point.transects = F, w.lo=0, w.hi=max(dist), 
...
F.dfunc.estim <- function (formula, data = NULL, likelihood="halfnorm", point.transects = F, w.lo=0, w.hi=max(dist), 
