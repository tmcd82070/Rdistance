#' @title Rdistance options - Parameters for \code{Rdistance} optimization.
#' 
#' @aliases control, controls, RdistanceControls
#' 
#' @concept control, optimization
#' 
#' @description Control parameters used in 
#' \code{Rdistance} set by calls to \code{options()}.
#' 
#' \decribe{
#'   \item{Rdist_maxIters}{The maximum number of optimization 
#' iterations allowed.}
#' 
#'   \item{Rdist_evalMax}{The maximum number of objective function
#' evaluations allowed.}
#' 
#'   \item{Rdist_likeTol}{Minimum change in the likelihood 
...
#' 
#'   \item{Rdist_coefTol}{Minimum change in model coefficients 
...
#'
#'   \item{Rdist_optimizer}{A string specifying the optimizer 
...
#'
#'   \item{Rdist_hessEps}{A vector of parameter distances used during 
...
#'  
#'   \item{Rdist_requireUnits}{A logical specifying whether measurement 
...
#' 
#'   \item{Rdist_maxBSFailPropForWarning}{The proportion of bootstrap 
