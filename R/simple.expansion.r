...
#'   \itemize{
#'     \item **First term**: \deqn{h_1(x)=x^4,}{h1(x) = x^4,}
#'     \item **Second term**: \deqn{h_2(x)=x^6,}{h2(x) = x^6,}
#'     \item **Third term**: \deqn{h_3(x)=x^8,}{h3(x) = x^8,}
#'     \item **Fourth term**: \deqn{h_4(x)=x^{10},}{h4(x) = x^10,}
#'   }
