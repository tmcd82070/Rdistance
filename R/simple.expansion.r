...
#'   
#' @return A matrix of size \code{length(x)} X \code{expansions}.  The columns of this matrix are 
#' the Simple polynomial expansions of \code{x}. Column 1 is the first expansion term of \code{x}, 
#' column 2 is the second \code{x}, and so on up to \code{expansions}.
#'   
#' @seealso \code{\link{dfuncEstim}}, \code{\link{cosine.expansion}}, \code{\link{hermite.expansion}}
#'   
#' @examples 
