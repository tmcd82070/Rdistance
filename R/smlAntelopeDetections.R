#' @name smlAntelopeDetections
#' 
#' @title Small antelope detection data on walking transects
#' 
#' @description 
...
#' @docType data
#' 
#' @format A data.frame containing 129 rows and 11 columns.  Each row represents
...
#'   \item \code{surveyID}: Composite of year_season. 
#'   \item \code{transID}: Transect ID.  Transect IDs are 4 character strings XXXY, 
#'   where XXX is the grid cell number and Y is the transect number.
...
#' }
#' 
#' @seealso \code{\link{smlAntelopeTransects}}
#' 
#' @source The small antelope data is a subset of walking transect data collected 
#' by Lion Landscapes (\link{https://www.lionlandscapes.org}). 
#' 
#' @keywords datasets
NULL